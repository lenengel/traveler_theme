...
if (!class_exists('AvailabilityHelper')) {
    class AvailabilityHelper
    {
        ...
        public function insert_calendar_bulk($data, $posts_per_page, $total, $current_page, $all_days, $post_id)
        {
            ...
            if ($data['groupday'] == 0) {
                for ($i = $start; $i <= $end; $i++) {
                    ...
                    /*  .End */
                    $this->traveler_insert_availability($data['post_id'], $data['start'], $data['end'], $data['price'], $data['adult_price'], $data['children_price'], $data['infant_price'], $data['starttime'], $data['count_starttime'], $data['status'], $data['groupday'], $number_booked, $table);
                }
            } else {
                for ($i = $start; $i <= $end; $i++) {
        ...
        public function traveler_insert_availability($post_id = '', $check_in = '', $check_out = '', $price = '', $adult_price = '', $children_price = '', $infant_price = '', $starttime = '', $count_starttime = '', $status = '', $group_day = '', $number_booked = '', $table = null)
        {
            if (empty($table))
                $table = 'st_availability';
            global $wpdb;
