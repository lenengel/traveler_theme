                    ...
                    if(st_check_service_available('st_tours')) {
                        ...
                        while ($query_service->have_posts()):
                            ...
                            if($list_style == 'list'){
                                ...
                                $html .= apply_filters('st_elementor_loop_tour_grid_service_view' , st()->load_template('layouts/elementor/tour/loop/normal-grid', '', array('slider' => $list_style , 'item_row' => $item_row)) , $grid_tour_style , $list_style,  $item_row);
